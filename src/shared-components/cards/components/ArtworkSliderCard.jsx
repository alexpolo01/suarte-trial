...
export default function ArtworkSliderCard({
  artworkData,
  cardClassName = "",
  imageClassName = "",
  hideText = false,
  ...
  return (
    <>
      <div
        className={`artwork-slider-card__card ${cardClassName} ${
          onClick ? "pointer" : ""
        }`}
        onClick={onClick}
      >
        ...
        {!hideText && (
          <>
            <div className="artworks-slider-card__card-content-no-layout">
              ...
              <Text
                className="artworks-slider-card__card-content-text artist dots-on-overflow"
                paragraph
                small
              >
                {artworkData.artwork_about.artwork_artist
                  ? artworkData.artwork_about.artwork_artist.user_name
                  : artworkData.artwork_about.artwork_gallery_artist
                    .artist_name}
              </Text>
              ...
              <Text
                className="artworks-slider-card__card-content-text price dots-on-overflow"
                paragraph
                small
              >
            ...
            <div className="artworks-slider-card__card-content-layout">
              <Text
                className="artworks-slider-card__card-content-title"
                paragraph
                medium
              >
                .
              ...
              <Text
                className="artworks-slider-card__card-content-text artist"
                paragraph
                small
              >
                .
              </Text>
              <p className="artworks-slider-card__card-content-text medium-year">
                .
              </p>
              <Text
                className="artworks-slider-card__card-content-text price"
                paragraph
                small
              >
                .
