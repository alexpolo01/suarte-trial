...
export default function VirtualList({ items, onLoadMore, navigateToArtwork }) {
  ...
  function initColumnSizesCache() {
    const columnCount = screenSize.width <= 700 ? 2 : 3;
    const spacer = screenSize.width <= 550 ? 10 : 15;
    const widthOfList = Math.min(screenSize.width, 1200) - 22;
  ...
  return (
    <>
      <InfiniteScroll 
        ...
        className="user-profile-artworks__infinite-scroll-wrapper" 
        defaultInfiniteLoaderClassName="user-profile-artworks__infinite-scroll-spinner"
      >
