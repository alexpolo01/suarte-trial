...
export default function VirtualList({ items, onLoadMore, navigateToArtwork }) {
  ...
  function initColumnSizesCache() {
    ...
    const widthOfList = screenSize.width <= 650 ? screenSize.width-22 : screenSize.width <= 1004 ? screenSize.width-40 : screenSize.width <= 1400 ? screenSize.width-60 : Math.min(1720, screenSize.width - 80);
  ...
  return (
    <>
      <InfiniteScroll 
        ...
        className="home-artworks__infinite-container"
      >
